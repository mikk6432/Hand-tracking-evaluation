...
public class ServerUI : MonoBehaviour
{
    ...
    private void StartExperiment()
    {
        ...
        NetworkManager.Singleton.ConnectedClientsList[0].PlayerObject.GetComponent<HeadsetBehaviour>().StartExperimentClientRpc(personId, leftHanded, standing);
    }

    private void StopExperiment()
    {
        NetworkManager.Singleton.ConnectedClientsList[0].PlayerObject.GetComponent<HeadsetBehaviour>().StopExperimentClientRpc();
    }

    private void RecalculatePath()
    {
        NetworkManager.Singleton.ConnectedClientsList[0].PlayerObject.GetComponent<HeadsetBehaviour>().RecalculatePathClientRpc();
    }
